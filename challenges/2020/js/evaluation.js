...
var FIRSTNAME;
var LASTNAME;
var serverurl = "http://ec2-35-167-219-180.us-west-2.compute.amazonaws.com/evaluation_server";
var files = "http://ec2-35-167-219-180.us-west-2.compute.amazonaws.com/files";
var TASKID = 2;
var USERID;
var fullname;
var PUBLIC = 'true';
...
json_file_classification = "http://ec2-35-167-219-180.us-west-2.compute.amazonaws.com/files/example_classification.json";
json_file_detection = "http://ec2-35-167-219-180.us-west-2.compute.amazonaws.com/files/example_detection.json";
...
function print_classification_content() {
    ...
    var html = '<h3> Submission Panel: <span style="color:red;"> One submission per team per week (per task)</span>  </h3>'
    html += '<div id="evaluate" >'+
...
function print_results() {
    ...
    $("#leader_div").show();
  load_leaderboard(actionstatus='localization');
  $('#leaderboard li').on('click', function(){
    ...
    // }
    if(currid == "#leaderboard_localization"){
      $('#myTable tbody>tr').empty();
...
function load_leaderboard(STATUS){
  ...
  var task_mapping = {'localization': 2, 'captioning': 3, 'trimmed': 4, 'spatiotemporal': 5, 'spatiotemporal_full': 6}
