...
$(document).ready(function(){
  $('iframe').hide();
  $.ajax({
    url: "http://ec2-52-25-205-214.us-west-2.compute.amazonaws.com/generate_treeview.php",
    type: "POST",
...
$('body').on('click', '.nextpage',function(e){
  ...
  $.ajax({
    url:"http://ec2-52-25-205-214.us-west-2.compute.amazonaws.com/getvideos.php",
    type:"POST",
